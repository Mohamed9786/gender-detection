...
# Load YOLO
net = cv2.dnn.readNet("C:\\Users\\HP\\Downloads\\gender-detection\\yolov3\\yolov3.weights", "C:\\Users\\HP\\Downloads\\gender-detection\\yolov3\\yolov3.cfg")
layer_names = net.getLayerNames()
output_layers = [layer_names[i - 1] for i in net.getUnconnectedOutLayers()]
classes = open("C:\\Users\\HP\\Downloads\\gender-detection\\yolov3\\coco.names").read().strip().split("\n")

# Load pre-trained gender classification model
gender_model = tf.keras.models.load_model("C:\\Users\\HP\\Downloads\\gender-detection\\model\\gender_model.h5")
